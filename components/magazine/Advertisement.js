	...
	return (
		<div className={advertisementStyles["container"]}>
			<div className={advertisementStyles["container-info"]}>
				<h1 className={advertisementStyles["info-title"]}>Up Your Productivity Game</h1>
				<p className={advertisementStyles["info-summary"]}>With Bevl, don't just set deadlines, plan when you'll do them.</p>
			</div>
			<form onSubmit={handleSubmit} className={advertisementStyles["container-form"]}>
			...
			<div className={advertisementStyles["container-image"]}>
				<Link href={"/"}>
					<Image src={"/images/logo-complete.svg"} layout="fill" className={advertisementStyles["image"]} draggable="false" />
				</Link>
			</div>
		</div>
	);
