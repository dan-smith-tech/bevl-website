        ...
        <div className={roadmapStyles.containerMain}>
          ...
          <div className={roadmapStyles.roadmapFeatures}>
            ...
            <ul className={roadmapStyles.roadmapFeaturesList}>
              <li className={roadmapStyles.roadmapFeaturesListElement}>Deadline plans signify their time occurance relative to their associated Deadline (e.g., if a Deadline plan occurs after the Deadline itself, users will be signified that they are planning to work on the task after it&apos;s due).</li>
              ...
              <li className={roadmapStyles.roadmapFeaturesListElement}>Recipe book: individual recipes can be created, each with cooking steps and ingredients. Weekly meal plans can be made by selecting created recipes, and a shopping list can then be generated.</li>
              <li className={roadmapStyles.roadmapFeaturesListElement}>Workout routines: individual exercises can be created, where notes and videos can be recorded. Workout routines can then be created by dragging individual exercises into a schedule.</li>
            </ul>
          </div>
        </div>
    </Layout>
