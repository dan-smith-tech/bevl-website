        ...
        <div className={roadmapStyles.containerMain}>
          ...
          <div className={roadmapStyles.roadmapFeatures}>
            ...
            <ul className={roadmapStyles.roadmapFeaturesList}>
              ...
              <li className={roadmapStyles.roadmapFeaturesListElement}>Tasks can be toggled on and off in the list bar; by time occurance (e.g., "only show tasks that occur in the next month"), task type, and by label.</li>
              ...
              <li className={roadmapStyles.roadmapFeaturesListElement}>There is a mood board where you can make "sticky note" lists, for random, unorganised, pieces of information you might want to keep track of.</li>
