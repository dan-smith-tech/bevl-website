			...
			<div className={"container-full " + aboutStyles["container-full"]}>
				<div className={"container-partial " + aboutStyles["container-partial"]}>
					<div className={aboutStyles["content-text"]}>
						<h1>My Story</h1>
						<p>
							Like many people, I have always liked to make sure I&apos;m ahead of the work I need to get
							done. I have also always found technology a great tool to facilitate and aid me with these
							duties.
						</p>
						<p>
							...
							having to spend time adjusting my plans because things that I couldn&apos;t have prepared for
							would arise. I realised I was spending too much time rewriting plans and micromanaging the
							tasks I needed to get done, and that I wasn&apos;t working on the important things.
						</p>
						<p>
